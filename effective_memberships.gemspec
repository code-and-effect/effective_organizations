...
Gem::Specification.new do |spec|
  spec.name        = 'effective_organizations'
  spec.version     = EffectiveOrganizations::VERSION
  spec.authors     = ['Code and Effect']
  spec.email       = ['info@codeandeffect.com']
  spec.homepage    = 'https://github.com/code-and-effect/effective_organizations'
  spec.summary     = 'Users have many organizations through representatives.'
  spec.description = 'Users have many organizations through representatives.'
  spec.license     = 'MIT'
